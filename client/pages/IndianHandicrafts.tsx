...
export function IndianHandicrafts() {
  const products = [
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="font-playfair font-normal text-4xl text-veblyssText mb-8">
              Authentic Indian handicrafts showcasing centuries-old traditions and artisan skills, 
              bringing cultural heritage and artistic beauty to homes worldwide.
            </h2>
          </div>
        </div>
      </section>
